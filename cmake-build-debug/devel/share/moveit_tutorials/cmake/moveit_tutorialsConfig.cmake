...
if("TRUE" STREQUAL "TRUE")
  set(moveit_tutorials_SOURCE_PREFIX /home/marek/catkin_rrm/src/moveit_tutorials)
  set(moveit_tutorials_DEVEL_PREFIX /home/marek/catkin_rrm/src/cmake-build-debug/devel)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marek/catkin_rrm/src/moveit_tutorials/${idir}'.  ${_report}")
    endif()
